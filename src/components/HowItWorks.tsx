...
export const HowItWorks = () => {
  ...
  return <section className="py-20 bg-gradient-to-b from-gray-950 to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {steps.map((step, index) => <Card key={index} className="bg-gray-900/50 border-gray-800 relative group hover:border-purple-500/50 transition-all duration-300">
